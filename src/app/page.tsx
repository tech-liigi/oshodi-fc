            ...
            {section.visible && (
              <>
                ...
                {section.id === "cta" && (
                  <section
                    key={section.id}
                    className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 xl:grid-cols-2 gap-4 w-full xl:x-16 lg:px-16 lg:py-16 md:px-16 md:py-16 sm:px-5 sm:py-12 xl:py-16 xl:mt-0 lg:mt-0 md:mt-0"
                  >
                    <h1
