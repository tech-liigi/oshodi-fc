...
const Header = (props:
    ...
    return (
        ...
        <header>
            ...
            <><div className="w-full top-0 z-10 absolute drop-shadow-md max-h-[180px]" id="header"><MainHeader title={props.logo.title} logo={props.logo.logo} menuItems={props.menuItems} paddingResize={active}/><SubHeader els={subnav}/></div></>
            </div>
        </header>
    )
}
